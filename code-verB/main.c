...
void main(void)
{
    unsigned char CVD_status=0;     //0:CVD_res<CVD_th, 1:CVD>CVD_th
    unsigned char CVD_old_status=0; //last time CVD_status
    ...
    init_LCM();
    init_CVD();
    for(unsigned char i=0;i<4;i++)          //display CVD_th[0~3] on LCM
    {
    ...
    {
        CVD_res = CVD(sensor);
        LCM_pattern(30,sensor,((unsigned char)(CVD_res>>12)) & 0x0F);
        LCM_pattern(36,sensor,((unsigned char)(CVD_res>>8)) & 0x0F);
        LCM_pattern(42,sensor,((unsigned char)(CVD_res>>4)) & 0x0F);
        LCM_pattern(48,sensor,((unsigned char) CVD_res) & 0x0F);
        if(CVD_res>CVD_th[sensor])
        {
            switch (sensor)
            {
                case 0: CVD_status=(CVD_status | 0x01);   break;
                case 1: CVD_status=(CVD_status | 0x02);   break;
                case 2: CVD_status=(CVD_status | 0x04);   break;
                case 3: CVD_status=(CVD_status | 0x08);   break;
            }
        }
        else
        {
            switch (sensor)
            {
                case 0: CVD_status=(CVD_status & 0xFE);   break;
                case 1: CVD_status=(CVD_status & 0xFD);   break;
                case 2: CVD_status=(CVD_status & 0xFB);   break;
                case 3: CVD_status=(CVD_status & 0xF7);   break;
            }
        }
        if (CVD_status != CVD_old_status)
        {
...
//            if(tmr0_counter > 10)           //debounce time = 9~10msec
            if(tmr0_counter > 2)           //debounce time = 1~2msec
            {
                CVD_old_status=CVD_status;
                tmr0_counter = 0;
            }
        }
        else
        {
            tmr0_counter = 0;
            sensor++;   if(sensor>3)    sensor=0;
        }
        LED_op(CVD_old_status);
    }
}
void init_CVD(void)
{
...
void LED_op(unsigned char CVD_status)
{
    switch (CVD_status)
    {
        case 0 :    LED1=0; LED2=0; LED3=0; LED4=0; LED5=0; LED6=0; LED7=0; break;
        case 1 :    LED1=1; LED2=0; LED3=0; LED4=0; LED5=0; LED6=0; LED7=0; break;
        case 2 :    LED1=0; LED2=0; LED3=1; LED4=0; LED5=0; LED6=0; LED7=0; break;
        case 3 :    LED1=0; LED2=1; LED3=0; LED4=0; LED5=0; LED6=0; LED7=0; break;
        case 4 :    LED1=0; LED2=0; LED3=0; LED4=0; LED5=1; LED6=0; LED7=0; break;
        case 6 :    LED1=0; LED2=0; LED3=0; LED4=1; LED5=0; LED6=0; LED7=0; break;
        case 8 :    LED1=0; LED2=0; LED3=0; LED4=0; LED5=0; LED6=0; LED7=1; break;
        case 12 :   LED1=0; LED2=0; LED3=0; LED4=0; LED5=0; LED6=1; LED7=0; break;
//        case 7 :    LED1=0; LED2=0; LED3=1; LED4=0; LED5=0; LED6=0; LED7=0; break;
//        case 14 :   LED1=0; LED2=0; LED3=0; LED4=0; LED5=1; LED6=0; LED7=0; break;
//        default:    LED1=0; LED2=0; LED3=0; LED4=0; LED5=0; LED6=0; LED7=0; break;
    }
}
